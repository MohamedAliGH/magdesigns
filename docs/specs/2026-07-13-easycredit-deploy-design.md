...
| Repo name | **`magdesigns`** → live at `https://MohamedAliGH.github.io/magdesigns/` |
...
3. Push `main`. Repo Settings → Pages → source = `main` / root. Site live at `https://MohamedAliGH.github.io/magdesigns/`.
